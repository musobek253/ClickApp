...
public interface MapstructMapper {
   ...
   CommentResDto toCommentDto(Comment comment);
    ...
    @Mapping(source = "taskId.id", target = "taskId")
    CheckListResDto toChkDto(CheckList checkList);
    List<CheckListResDto> toChkDto(List<CheckList> checkLists);
    /**
     * checkListItem
     */
    @Mapping(source = "checkListId.id", target = "checkListId")
    CheckListItemResDto toCheckListItemDto(CheckListItem checkListItem);
    List<CheckListItemResDto> toCheckListItemDto (List<CheckListItem> checkListItemList);
